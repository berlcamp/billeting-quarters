...
export default async function MedicalIncidentsPage() {
  const profile = await getCurrentProfile();
  if (!profile || !hasPermission(profile, "incident.view")) {
    return (
      <Forbidden message="You don't have permission to view medical incidents." />
    );
  }
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Incidents categorized as medical. Open one to refer the patient to a UCF."
        actions={
          canCreate ? (
            <Link
